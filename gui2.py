...
set_end_button = tk.Button(frame, text="Set End Position", command=send_end_only, bg="#000000", fg="white")
...
set_time_button = tk.Button(frame, text="Set Time Duration", command=send_time_only, bg="#000000", fg="white")
